...
public class Option : MonoBehaviour
{
    ...
    public async void Selected()
    {
        ...
        {
            await Correct(currentQuestion.questionNumber);
        ...
        {
            await InCorrect(currentQuestion.questionNumber);
            /*currentQuestion.isAnswered = true;
            currentQuestion.questionNumber++;
            startQuestions++;
            switchQuestion(startQuestions);*/
    ...
    public async Task Correct(int questionNumber)
    {
        ...
        string scoreAccessToken = GameObject.FindWithTag("InputField").GetComponent<Input_Field>().retrieveToken.ToString();
        //Debug.Log(scoreAccessToken);
        scoreSubmitRequest.AddHeader("accesstoken", scoreAccessToken);
        scoreSubmitRequest.AddHeader("Content-Type", "application/json");
        var scoreBody = @"{
" + "\n" +
@"    ""actor"": {
" + "\n" +
@"        ""mbox"": ""mailto:admin@team47996.testinator.com"",
" + "\n" +
@"        ""name"": ""test-user"",
" + "\n" +
@"        ""objectType"": ""Agent""
...
@"        ""platform"": ""Test Class"",
" + "\n" +
@"        ""registration"": ""4b04f1f3-fd84-4422-9bbb-19e6ea05f4d0"",
" + "\n" +
@"        ""instructor"": {
" + "\n" +
...
@"}";        
    ...
    public async Task InCorrect(int questionNumber)
    {
